...
#ifndef COINSY_TROLLBOX_MANAGER_HPP
#define COINSY_TROLLBOX_MANAGER_HPP
...
namespace coinsy {
    ...
    class trollbox_manager
    {
        ...
        private:
             ...
             * The trollboxes.
             */
            std::map<std::string, std::shared_ptr<trollbox> > m_trollboxes;
...
#endif // COINSY_TROLLBOX_MANAGER_HPP
